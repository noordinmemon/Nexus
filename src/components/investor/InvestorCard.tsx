      ...
      <CardBody className="flex flex-col">
        <div className="flex items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {(investor.industries || []).map((stage: string, index: number) => (
        ...
        <div className="mt-3">
          ...
          <div className="flex flex-wrap gap-2">
            {(investor.industries || []).map((interest: string, index: number) => (
        ...
        <div className="mt-4">
          <p className="text-sm text-gray-600 line-clamp-2">{investor.bio || 'No bio yet'}</p>
        </div>
